...
void draw() {
  ...
  float previous_acc_y_ = acc_y_;
  acc_y_ = acc_y - sin(theta_rad);
  
  println(acc_data[0]);
  //plot(pitch,previous_pitch,51,102,200,1);        //BLUE
  plot(acc_data[1],acc_data_0,200,20,200,100);          //MAGENTA
  plot(acc_y_,previous_acc_y_,200,102,51,100);      //ORANGE
  integrator_plot(acc_y*100);
